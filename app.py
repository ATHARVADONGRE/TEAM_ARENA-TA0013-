...
from models import db, HR, Student, Job, JobSkill, Application, StudentSkill, Resume, SavedJob, Internship, BusinessJob, SkillTest, HRNote, InterviewEmail, InternshipSkill, InternshipApplication
...
Provide readiness level and a detailed improvement plan."""
    ...
    @app.route('/dashboard/student/internships')
    def student_internships():
        return render_template('student_internships.html')
    
    @app.route('/dashboard/student/internship-applications')
    def student_internship_applications():
        return render_template('student_internship_applications.html')
    ...
    # HR INTERNSHIP ROUTES
    @app.route('/dashboard/hr/post-internship')
    def hr_post_internship():
        return render_template('hr_post_internship.html')
    
    @app.route('/dashboard/hr/internships')
    def hr_internships():
        return render_template('hr_internships.html')
    
    @app.route('/dashboard/hr/internship-applicants/<int:internship_id>')
    def hr_internship_applicants(internship_id):
        return render_template('hr_internship_applicants.html', internship_id=internship_id)
